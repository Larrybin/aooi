...
const generatedByWranglerPattern =
  /^\/\/ Generated by Wrangler by running `wrangler types --config .*?` \(hash: [^)]+\)$/m;
...
function normalizeTrackedTypes(content) {
  return content.replace(
    generatedByWranglerPattern,
    stableGeneratedByWranglerComment
  );
}
