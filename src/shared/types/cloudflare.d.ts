/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config /Users/bin/Desktop/project/aooi/wrangler.cloudflare.toml --env-interface CloudflareEnv src/shared/types/cloudflare.d.ts` (hash: 99f2720110eb37ab23be20ad60a695c1)
// Runtime types generated with workerd@1.20260415.1 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../../cloudflare/workers/router");
	}
	interface Env {
		...
		NEXT_PUBLIC_APP_NAME: "Roller Rabbit";
		...
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler from roller-rabbit-state */;
		NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace /* DOShardedTagCache from roller-rabbit-state */;
		STATEFUL_LIMITERS: DurableObjectNamespace /* StatefulLimitersDurableObject from roller-rabbit-state */;
		WORKER_SELF_REFERENCE: Service<typeof import("../../../cloudflare/workers/router").default>;
		PUBLIC_WEB_WORKER: Fetcher /* roller-rabbit-public-web */;
		AUTH_WORKER: Fetcher /* roller-rabbit-auth */;
		PAYMENT_WORKER: Fetcher /* roller-rabbit-payment */;
		MEMBER_WORKER: Fetcher /* roller-rabbit-member */;
		CHAT_WORKER: Fetcher /* roller-rabbit-chat */;
		ADMIN_WORKER: Fetcher /* roller-rabbit-admin */;
	}
}
