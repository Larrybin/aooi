// data: landing translations (header/footer) + theme layout + build-safe site config
// cache: default RSC
// reason: share the landing shell for AI demo pages; gate access via site config
