...
8. Add `deploy.preview.settings.json` only if a workers.dev preview runtime is needed.
9. Run the site/config checks listed in the skill before production-like work.
